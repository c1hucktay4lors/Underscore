...
class MainWindow(QMainWindow):
    ...
    def _build_ui(self):
        ...
        self.sld_resume_hold = FloatSlider(0.0, 1.5, 0.05, "{:.2f}", " s")
        f_duck.addRow("Resume Hold", self.sld_resume_hold)
        self.sld_pause_confirm = FloatSlider(0.0, 3.0, 0.1, "{:.1f}", " s")
        f_duck.addRow("Pause Confirm", self.sld_pause_confirm)
    ...
    def _cfg_to_widgets(self, c: Config):
        ...
        self.sld_pause_confirm.setValue(c.pause_confirm)
    ...
    def _widgets_to_cfg(self) -> Config:
        ...
        base.pause_confirm = round(self.sld_pause_confirm.value(), 1)
